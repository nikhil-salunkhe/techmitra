...
const trainingQA = {
  ...
  'fee': { answer: '💰 Our training program costs just ₹4,999 (one-time payment) for the complete 2-month program. This includes live sessions, project development, 1-on-1 mentorship, certificate, and more. No hidden charges!', suggestions: ['What\'s included?', 'How to pay?', 'Other programs?'] },
  'price': { answer: '💰 The total fee for our 2-month intensive training program is ₹4,999 only. This is a one-time payment with no installment or hidden fees.', suggestions: ['What do I get?', 'Duration of training?', 'Enroll now'] },
  'cost': { answer: '💵 Our training program is priced at just ₹4,999 for the complete 2-month duration. This includes all learning materials, live sessions, mentorship, and certificate.', suggestions: ['Is there a refund policy?', 'What is covered?', 'How to join?'] },
  ...
  'month': { answer: '⏱️ Our program is 2 months long - designed to be intensive and comprehensive. You\'ll complete a full-stack project in this time with 1-on-1 mentorship.', suggestions: ['What technologies?', 'Project work?', 'Certificate?'] },
  'technology': { answer: '💻 We offer training in the following technologies:\n\n1️⃣ MERN Stack (MongoDB, Express, React, Node.js)\n2️⃣ Java Full Stack\n3️⃣ Python Full Stack\n4️⃣ React Native\n\nAll programs include project development and placement preparation.', suggestions: ['Which is best for me?', 'MERN Stack details', 'Python Full Stack'] },
  'mern': { answer: '⚛️ MERN Stack includes: MongoDB (Database), Express.js (Backend), React.js (Frontend), Node.js (Runtime). You\'ll build a complete full-stack project from scratch during the 2-month program!', suggestions: ['Fee details', 'Duration', 'Enroll now'] },
  'python': { answer: '🐍 Python Full Stack covers: Python, Django/Flask, PostgreSQL, HTML/CSS/JavaScript. You\'ll build real-world applications with industry-standard practices.', suggestions: ['MERN Stack details', 'Java Full Stack', 'Fee'] },
  'java': { answer: '☕ Java Full Stack includes: Core Java, Spring Boot, Hibernate, MySQL, React/Angular for frontend. Enterprise-grade application development with best practices.', suggestions: ['Python Full Stack', 'MERN Stack', 'Duration'] },
  'react native': { answer: '📱 React Native for mobile app development. Build cross-platform iOS and Android apps using React. Covers navigation, state management, API integration, and app deployment.', suggestions: ['MERN Stack', 'Fee', 'Duration'] },
  'enroll': { answer: '✅ To enroll, simply fill out the registration form on our Enrollment page. The process is:\n\n1️⃣ Fill the enrollment form\n2️⃣ Pay ₹4,999 (one-time)\n3️⃣ Get onboarded with welcome kit\n4️⃣ Start learning!\n\nA confirmation email will be sent to you after successful enrollment.', suggestions: ['Fee details', 'What do I get?', 'Contact support'] },
